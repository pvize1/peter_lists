...
app_name = "books"
urlpatterns = [
    path(route="", view=views_books.BookHome, name="home"),
    path(route="list/", view=views_books.BookListView.as_view(), name="list"),
    ...
    path(route="delete/<slug:slug>/", view=views_books.BookDeleteView.as_view(), name="delete"),
